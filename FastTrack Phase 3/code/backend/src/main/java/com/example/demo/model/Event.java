...
public class Event {
    ...
    public Set<Long> getRegisteredTeamIds() { return registeredTeamIds; }
    ...
    public void setRegisteredTeamIds(Set<Long> registeredTeamIds) { this.registeredTeamIds = registeredTeamIds; }
